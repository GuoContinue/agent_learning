...
### [通过 QLoRA 微调让小模型内化工具知识](https://arxiv.org/abs/2605.17774)

**发表**：2026 年 5 月 18 日 | [arXiv:2605.17774](https://arxiv.org/abs/2605.17774)

**核心贡献**：本文针对工具调用 Agent 中反复注入完整工具 Schema 带来的上下文开销，提出用 8-bit QLoRA 在约 1,700 条工具使用样本上微调小模型，让工具知识部分内化到模型权重中。实验显示，在 Gemma 4 E4B 与 Qwen3-4B 上可减少约 82.6% 输入长度，并在工具规划评分上超过携带完整工具描述的基线；Qwen3-4B 还实现了约 62% 内存节省与 2.5 倍推理加速。
